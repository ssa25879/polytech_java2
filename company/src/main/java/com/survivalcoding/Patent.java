...
public class Patent extends IntangibleAsset{
    ...
    public Patent(String name, String assetType, LocalDate acquiredDate, String inventor, int patentNumber) {
    ...
    private void setInventor(String inventor) {
        if (inventor == null) {
    ...
    private void setPatentNumber(int patentNumber) {
        if (patentNumber < 0) {
